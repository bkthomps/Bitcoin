...
def buildm1():
    ...
    m1 = BitArray(bin=leadingZeroespk1) + BitArray(bin="{0:b}".format(pk1)) + BitArray(bin=leadingZeroespk2) + BitArray(
        bin="{0:b}".format(pk2)) + amt1
    print(len(m1))
    return m1.hex
...
def buildm2():
    ...
    m2 = BitArray(bin=leadingZeroespk2) + BitArray(bin="{0:b}".format(pk2)) + BitArray(bin=leadingZeroespk3) + BitArray(
        bin="{0:b}".format(pk3)) + amt2
    print(len(m2))
    return m2.hex
